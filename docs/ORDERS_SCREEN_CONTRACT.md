...
> **d.ii.** 🔴 **THE RATE IS CONFIGURATION AND IS UNSET BY DEFAULT. UNSET RECORDS NULL, NEVER
> ZERO.** ⚠ **A `0%` line CLAIMS no tax applies; absence says nobody has decided** (`SYS-034`).
> **`V22`'s CHECK keeps the rate and the amount stated together — a rate without an amount is a
