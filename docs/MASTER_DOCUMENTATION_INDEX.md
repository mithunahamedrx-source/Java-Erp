...
**Version:** 1.56.11 · **Ratified:** 2026-08-04 · **Amended:** 2026-08-09 (**file reconstructed after data loss — see Appendix C 1.23.1**; **state-machine ratification — `BR-142`**; **pre-freeze GAP and cross-document reconciliation**; `DOC-061`) · **Amended:** 2026-08-08 (Sales reconciliation; immutability `BD-254`; serial policy `BD-242`; discount policy `BD-255`; Warehouse & Assembly §17; Purchase & Supplier §18; Accounting §19; **documentation consistency pass**) · **Last verified against `/docs`:** 2026-08-09
...
|---|---|---|---|
| 1 | `MASTER_DOCUMENTATION_INDEX.md` | 🧊 **Under freeze governance** — current v1.56.11 | `DOC-001`–`DOC-080` (`DOC-059` withdrawn) |
| 2 | [`DESIGN_CONSTITUTION.md`](DESIGN_CONSTITUTION.md) | ✅ **Ratified** v2.7.0 | Article/rule numbering |
| 3 | [`design-reference/README.md`](design-reference/README.md) | ✅ **Ratified** | Binding images |
| 4 | [`ORDER_MANAGEMENT_ARCHITECTURE.md`](ORDER_MANAGEMENT_ARCHITECTURE.md) | ✅ **Ratified** v1.19.0 | `BR-001`–`BR-141` |
| 5 | [`SYSTEM_ARCHITECTURE.md`](SYSTEM_ARCHITECTURE.md) | ✅ **Ratified** v1.15.0 | `CP-1`–`CP-14` · `SYS-001`–`SYS-107` |
| 6 | [`DATABASE_ARCHITECTURE.md`](DATABASE_ARCHITECTURE.md) | ✅ **Ratified** v1.2.0 | `DB-001`–`DB-079` |
| 7 | [`PERMISSION_ARCHITECTURE.md`](PERMISSION_ARCHITECTURE.md) | ✅ **Ratified** v1.11.0 | `PRM-001`–`PRM-078` |
| 8 | [`AUDIT_ARCHITECTURE.md`](AUDIT_ARCHITECTURE.md) | ✅ **Ratified** v1.6.0 | `AUD-001`–`AUD-043` |
| 9 | [`PRODUCT_ARCHITECTURE.md`](PRODUCT_ARCHITECTURE.md) | ✅ **Ratified** v1.12.0 | `PRD-001`–`PRD-136` |
| 10 | [`DOMAIN_MODEL.md`](DOMAIN_MODEL.md) | ✅ **Ratified** v3.23.0 | `E-001`–`E-085` · `DM-001`–`DM-079` · `INV-` invariants |
...
| 13 | [`GAP_ANALYSIS.md`](GAP_ANALYSIS.md) | ✅ **Current** v2.43.1 | `GAP-001`–`GAP-125` |
...
| 19 | [`INVENTORY_COSTING_ARCHITECTURE.md`](INVENTORY_COSTING_ARCHITECTURE.md) | ✅ **Ratified** v1.2.0 — 2026-08-08 (`DOC-057`) | `ICO-000`–`ICO-034` |
| 20 | [`INVENTORY_ARCHITECTURE.md`](INVENTORY_ARCHITECTURE.md) | ✅ **Ratified** v1.5.0 — 2026-08-08 (`DOC-058`) | `IVN-000`–`IVN-039` |
| 21 | [`CUSTOMER_ARCHITECTURE.md`](CUSTOMER_ARCHITECTURE.md) | ✅ **Ratified** v1.1.0 — 2026-08-08 | `CUS-000`–`CUS-074` |
| 22 | [`WAREHOUSE_ARCHITECTURE.md`](WAREHOUSE_ARCHITECTURE.md) | ✅ **Ratified** v1.4.1 — 2026-08-08 | `WHS-000`–`WHS-072` |
...
| 26 | [`API_ARCHITECTURE.md`](API_ARCHITECTURE.md) | ✅ **Ratified** v1.3.0 — 2026-08-08 | `API-000`–`API-056` |
...
| 33 | [`TECHNOLOGY_ARCHITECTURE.md`](TECHNOLOGY_ARCHITECTURE.md) | ✅ **Ratified** v1.1.0 — 2026-08-10 (`DOC-074`) | `TEC-000`–`TEC-115` |
| 34 | [`PROJECT_CONSTITUTION.md`](PROJECT_CONSTITUTION.md) | ✅ **Ratified** v1.0.0 — 2026-08-10 (`DOC-075`) | `PRJ-001`–`PRJ-280` |
| 35 | [`UI_UX_ARCHITECTURE.md`](UI_UX_ARCHITECTURE.md) | ✅ **Ratified** v1.5.0 — 2026-08-11 (`DOC-076`) | `UX-001`–`UX-261` |
