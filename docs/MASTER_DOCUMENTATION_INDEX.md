...
|---|---|---|---|
| 1 | `MASTER_DOCUMENTATION_INDEX.md` | 🧊 **Under freeze governance** — current v1.61.4 | `DOC-001`–`DOC-092` (`DOC-059` withdrawn) |
...
| 13 | [`GAP_ANALYSIS.md`](GAP_ANALYSIS.md) | ✅ **Current** v2.57.0 | `GAP-001`–`GAP-133` |
